...
<head>
    ...
    <title>Time table maker Dashboard</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
              ...
              <p> <span style="color:#FFF" >Hello Sarvesh</span>
...
<a href="logout.php"><font color="#FFFFFF">Logout</font></a></span>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav" style="background-color:#000">
                    <li>
                        <a href="admindashboard.php?info=course"><i class="fa fa-fw fa-dashboard"></i>Add/Update Department</a>
                    </li>
                    <li>
                        <a href="admindashboard.php?info=semester"><i class="fa fa-fw fa-bar-chart-o"></i>Add/Update Semester</a>
                    </li>
                    <li>
                        <a href="admindashboard.php?info=subject"><i class="fa fa-fw fa-table"></i>Add/Update Subject</a>
                    </li>
                    <li>
                        <a href="admindashboard.php?info=teacher"><i class="fa fa-fw fa-desktop"></i>Add/Update Teacher</a>
                    </li>
                    
                    <li>
                        <a href="admindashboard.php?info=add_timetable"><i class="fa fa-fw fa-wrench"></i>Create Time Table</a>
                    </li>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
				...
				?>
                   ...
                   <font color="#FF3333" size="+3" face="Lucida Console, Monaco, monospace">Timetable maker Dashboard</font><br/>
                        <img src="img/timetable.jpg" class="img-responsive" alt="Cinque Terre" width="500" height="500" style="                          margin-top: 70px; margin-left: 23px;">
                <?php }?>
