...
<?php 
  ...
  if($_GET['generated']){
    ...
    if($weekTimeTable){
      ...
      <th class='text-center'>Lecture 3<br>11:15-12:15</th>
      <th class='text-center'>Lecture 4<br>12:15-01:15</th>
      <th class='text-center'>Break</th>
      <th class='text-center'>Lecture 5<br>02:00-03:00</th>
      <th class='text-center'>Lecture 6<br>03:00-04:00</th>";
      ...
      for($i = 0; $i < 5; $i++){
        ...
        for($j = 0; $j < 6; $j++){
            ...
            if($j === 1){
              echo "<th class=' text-center'><b style='text-sze=24'>".$sbreak[$i]."</b></th>";
            }
        }
        echo "</tr>";
      }
